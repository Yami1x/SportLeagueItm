...

{
...

    {
        ...
        modelBuilder.Entity<Sponsor>(entity =>
        {
            ...
            entity.HasIndex(s => s.Name).IsUnique(); // Índice único en Name
        });
        ...
        modelBuilder.Entity<TournamentSponsor>(entity =>
        {
            ...
            entity.Property(ts => ts.ContractAmount).IsRequired();
            ...
            entity.HasIndex(ts => new { ts.TournamentId, ts.SponsorId }).IsUnique(); // Índice único compuesto
        });
